    ...
    >
      <div className="flex items-start justify-between px-6 pt-8 pb-6" >
        <div >
          ...
          <a href="profile" ><Typography variant="h8" color="blue-gray"  >
          <i className="fa-solid fa-user-pen text-black" style={{marginRight:"8px"}}/>
          Edit Profile
      ...
      <div className="mb-12">
          ...
          <div className="mt-3 flex flex-col px-6 ">
            ...
            {/* <Button
              ...
              onClick={() => setSidenavType(dispatch, "none")}
            >
              <i class="fa-solid fa-circle-info" style={{ marginRight: '8px' }}></i>
          Help
            </Button> */}
            <Button
              className=""
    ...
    <div className="mb-12" >
      <hr />
        ...
        <Button
              ...
              fullWidth
            >
              <i className="fa-solid fa-right-from-bracket text-white" />
          Log Out
            </Button>
            {/* <Switch
              id="navbar-fixed"
